...
class CustomGATConv(MessagePassing):
    ...
    def __init__(
        ...
        self.reduce_proj = Linear(out_channels * heads, out_channels, False, weight_initializer='glorot')
        self.add_x = Linear(in_channels, out_channels, False, weight_initializer='glorot')
